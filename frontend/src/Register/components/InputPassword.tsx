...
const InputPassword: React.FC<Props> = (props: Props) => {
  ...
  return(
    <>
      ...
      <div>
        <PasswordInput checkValid={isValidPassword}
          value={passwordValue}
          onChange={(e: React.ChangeEvent<HTMLInputElement>) => { onChangeInput(e.target.value, 'password') }}
          placeholder="비밀번호 입력"
          type="password"
        />
        ...
        {isValidPassword && (
        <PasswordInputCheck checkSame={isSamePassword}
          value={passwordCheck}
          onChange={(e: React.ChangeEvent<HTMLInputElement>) => { onChangeInput(e.target.value, 'passwordCheck') }}
          placeholder="비밀번호 확인"
          type="password"
        />)}
